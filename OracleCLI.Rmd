...
pagetitle: "OCI CLI"
---
<div style="text-align: right"><i>Created by PJ Van Camp<br>Date created: 10 November 2020  
Last update: `r format(Sys.Date(), "%d %B %Y")`</i></div><br>

<div style="text-align: center"><h1>Tips on how to use the Oracle Cloud Infrastructure (OCI) Command Line Interface (CLI)</h1></div>
___
